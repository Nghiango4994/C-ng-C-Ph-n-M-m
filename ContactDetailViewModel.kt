//File này chứa
//thêm data class lưu trữ trạng thái (State) của Contact (gồm các thông tin họ tên, số điện
//thoại, email tương ứng các thành phần thông tin giao diện ContactDetailScreen)
...
class ContactDetailViewModelFactor(private val id: Int) :
